 ...
 */
class Caaportesdeudas extends \Sigcotweb\AplicativoBundle\Entity\Caaportesdeudas implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setCaprestamo($caprestamo);
    }

    public function getCaprestamo()
    {
        $this->__load();
        return parent::getCaprestamo();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'monto', 'fecha', 'caprestamo');
    }
