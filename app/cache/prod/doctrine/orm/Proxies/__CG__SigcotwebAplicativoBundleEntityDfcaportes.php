 ...
 */
class Dfcaportes extends \Sigcotweb\AplicativoBundle\Entity\Dfcaportes implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'monto', 'fecha', 'cooperativista');
    }
