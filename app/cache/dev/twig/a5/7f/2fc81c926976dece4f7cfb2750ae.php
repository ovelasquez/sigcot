...
/* AplicativoBundle:Caconfig:edit.html.twig */
class __TwigTemplate_a57f2fc81c926976dece4f7cfb2750ae extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>Caconfig edit</h1>

<form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("configcajadeahorro_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "AplicativoBundle:Caconfig:edit.html.twig";
    }
