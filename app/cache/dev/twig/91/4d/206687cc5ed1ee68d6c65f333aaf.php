...
/* AplicativoBundle:Caconfig:new.html.twig */
class __TwigTemplate_914d206687cc5ed1ee68d6c65f333aaf extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>Caconfig creation</h1>

<form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("configcajadeahorro_create"), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "AplicativoBundle:Caconfig:new.html.twig";
    }
