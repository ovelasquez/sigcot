...
/* AplicativoBundle:Dccargos:new.html.twig */
class __TwigTemplate_c34aa2e3f4c70d26458b68bb72a4d9a0 extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>Dccargos creation</h1>

<form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("cargoscooperativistas_create"), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "AplicativoBundle:Dccargos:new.html.twig";
    }
