...
/* AplicativoBundle:Dcfotosactivos:edit.html.twig */
class __TwigTemplate_ffdbc329681af2432720c407fae4198b extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>Dcfotosactivos edit</h1>

<form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("fotosactivos_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "AplicativoBundle:Dcfotosactivos:edit.html.twig";
    }
